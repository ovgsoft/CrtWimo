...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>graficas1 works!</p>\n");
...
/* harmony import */ var _service_usuario_usuario_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./service/usuario/usuario.service */ "./src/app/service/usuario/usuario.service.ts");
...
/* harmony import */ var _service_chat_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./service/chat.service */ "./src/app/service/chat.service.ts");
...
/* harmony import */ var angularfire2_firestore__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(angularfire2_firestore__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony import */ var _components_barras_barras_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/barras/barras.component */ "./src/app/components/barras/barras.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_barras_barras_component__WEBPACK_IMPORTED_MODULE_18__["BarrasComponent"]
        ],
        imports: [
            ...
            angularfire2__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_13__["environment"].firebase),
        ...
        providers: [
            _service_usuario_usuario_service__WEBPACK_IMPORTED_MODULE_11__["UsuarioService"],
            _service_chat_service__WEBPACK_IMPORTED_MODULE_15__["ChatService"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BarrasComponent", function() { return BarrasComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_service_usuario_usuario_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/service/usuario/usuario.service */ "./src/app/service/usuario/usuario.service.ts");



let BarrasComponent = class BarrasComponent {
    // 
...
BarrasComponent.ctorParameters = () => [
    { type: src_app_service_usuario_usuario_service__WEBPACK_IMPORTED_MODULE_2__["UsuarioService"] }
];
BarrasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-barras',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./barras.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/barras/barras.component.html")).default
    })
], BarrasComponent);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _service_usuario_usuario_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/usuario/usuario.service */ "./src/app/service/usuario/usuario.service.ts");
...
let RegisterComponent = class RegisterComponent {
    ...
    obtenerUsuarios() {
        this.us.obtenerUsuarios().subscribe(result => this.usuarios = result);
    }
    obtenerSuma() {
        this.us.obtenerSuma().subscribe(result => this.sumas = result);
    }
    obtenerCategorias() {
        this.us.obtenerCategorias().subscribe(result => this.categorias = result);
    }
    altaUsuario() {
        if (this.usuario.nombre == null) {
            ...
            this.us.altaUsuario(this.usuario).subscribe(datos => {
    ...
    bajaUsuario(id) {
        this.us.bajaUsuario(id).subscribe(datos => {
            if (datos['resultado'] == 'OK') {
                this.obtenerUsuarios();
            }
        });
    ...
    editarUsuario() {
        if (this.usuario.nombre == null || this.usuario.email == null || this.usuario.telefono == null || this.usuario.direccion == null) {
            ...
            this.us.editarUsuario(this.usuario).subscribe(datos => {
                if (datos['resultado'] == 'OK') {
                    this.obtenerUsuarios();
                }
            });
    ...
    seleccionarUsuario(id) {
        this.us.seleccionarUsuario(id).subscribe(result => this.usuario = result[0]);
    }
    hayRegistros() {
    ...
    // Productos
    obtenerProductos() {
        this.us.obtenerProductos().subscribe(result => this.productos = result);
    }
    altaProducto() {
        if (this.producto.codigo == null) {
            ...
            this.us.altaProducto(this.productos).subscribe(datos => {
                if (datos['resultado'] == 'OK') {
                    this.obtenerProductos();
                }
            });
    ...
    bajaProducto(id) {
        this.us.bajaProducto(id).subscribe(datos => {
            if (datos['resultado'] == 'OK') {
                this.obtenerProductos();
            }
        });
    ...
    editarProducto() {
        ...
        if (this.producto.codigo == null ||
            ...
            this.us.editarProducto(this.producto).subscribe(datos => {
                if (datos['resultado'] == 'OK') {
                    this.obtenerProductos();
                    this.obtenerSuma();
                }
    ...
    seleccionarProducto(id) {
        this.us.seleccionarProducto(id).subscribe(result => this.producto = result[0]);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _progress_progress_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./progress/progress.component */ "./src/app/pages/progress/progress.component.ts");
/* harmony import */ var _graficas1_graficas1_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./graficas1/graficas1.component */ "./src/app/pages/graficas1/graficas1.component.ts");
...
PagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _dasboard_dasboard_component__WEBPACK_IMPORTED_MODULE_4__["DasboardComponent"],
            _pages_component__WEBPACK_IMPORTED_MODULE_5__["PagesComponent"],
            _progress_progress_component__WEBPACK_IMPORTED_MODULE_2__["ProgressComponent"],
            _graficas1_graficas1_component__WEBPACK_IMPORTED_MODULE_3__["Graficas1Component"]
        ],
        exports: [
            _dasboard_dasboard_component__WEBPACK_IMPORTED_MODULE_4__["DasboardComponent"],
            _progress_progress_component__WEBPACK_IMPORTED_MODULE_2__["ProgressComponent"],
...
/* harmony import */ var _dasboard_dasboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dasboard/dasboard.component */ "./src/app/pages/dasboard/dasboard.component.ts");
/* harmony import */ var _progress_progress_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./progress/progress.component */ "./src/app/pages/progress/progress.component.ts");
/* harmony import */ var _graficas1_graficas1_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./graficas1/graficas1.component */ "./src/app/pages/graficas1/graficas1.component.ts");
/* harmony import */ var _login_register_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../login/register.component */ "./src/app/login/register.component.ts");
...
const pagesRoutes = [
    {
        ...
        children: [
            { path: 'dashboard', component: _dasboard_dasboard_component__WEBPACK_IMPORTED_MODULE_3__["DasboardComponent"], data: { titulo: 'Dashboard' } },
            { path: 'progress', component: _progress_progress_component__WEBPACK_IMPORTED_MODULE_4__["ProgressComponent"], data: { titulo: 'Progress' } },
            { path: 'graficas1', component: _graficas1_graficas1_component__WEBPACK_IMPORTED_MODULE_5__["Graficas1Component"], data: { titulo: 'Gráficas' } },
            { path: 'vista1', component: _login_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"], data: { titulo: 'Registro' } },
...
let ChatService = class ChatService {
    ...
    cargarMensajes() {
        this.itemCollections = this.afs.collection('chats', ref => ref.orderBy('fecha', 'desc')
            .limit(5));
        return this.itemCollections.valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((mensajes) => {
...
/* harmony import */ var _usuario_usuario_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./usuario/usuario.service */ "./src/app/service/usuario/usuario.service.ts");
...
/* harmony import */ var _nopagefound_nopagefound_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nopagefound/nopagefound.component */ "./src/app/shared/nopagefound/nopagefound.component.ts");
...
/* harmony import */ var _slidebar_slidebar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./slidebar/slidebar.component */ "./src/app/shared/slidebar/slidebar.component.ts");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _nopagefound_nopagefound_component__WEBPACK_IMPORTED_MODULE_4__["NopagefoundComponent"],
            _header_header_component__WEBPACK_IMPORTED_MODULE_5__["HeaderComponent"],
            _slidebar_slidebar_component__WEBPACK_IMPORTED_MODULE_7__["SlidebarComponent"],
...
SlidebarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./slidebar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/slidebar/slidebar.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./slidebar.component.css */ "./src/app/shared/slidebar/slidebar.component.css")).default]
    })
], SlidebarComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Chau\Desktop\wimo\CrtWiMo\src\main.ts */"./src/main.ts");
